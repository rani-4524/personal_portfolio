    ...
    return (
        <div className="navbar">
            ...
            <ul ref={menuRef}  className="nav-menu">
                ...
                <li><a className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Projects</p></a>{menu==='work'?<img src={underline} alt=""/>:<></>}</li>
            ...
            <div className="nav-connect">
               <a className='anchor-link' offset={50} href='#contact'>Contact me</a>
            </div>
        </div>
    )
}
